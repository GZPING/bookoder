                ...
                <table class="table table-bordered table-invoice">
                    ...
                    <s:iterator value="orderList">
									<tr>
										...
										<td class="text-center"><strong>$ <s:property value="price" /></strong></td>
										<td class="text-center"><strong><s:property value="number" /></strong></td>
										<td class="text-center"><strong>$<s:property value="totalPrice" /></strong></td>
										</tr>
									</s:iterator>
						<tr>
                    <tr>
