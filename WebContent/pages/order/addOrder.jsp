...
<body class="sticky-header">
	...
	<div class="main-content">
					...
					<div class="panel-body">
						<div class="form">
							<form class="cmxform form-horizontal adminex-form"
								...
								<input type="hidden" name="order.bookId" id="bookId"> <input
									type="hidden" name="order.courseId" id="courseId"> <input
								...
								<div class="form-group ">
									...
									<div class="col-lg-10">
										<textarea rows="3" class="form-control " id="description"
											name="order.description"></textarea>
									</div>
								</div>
								<div class="form-group">
		...
		<footer class="footer"> 2017 &copy; GOBOOK<a href="http://www.zhiping.me/"
			target="_blank"> &nbsp;ZPING</a> </footer>
		<!--footer section end-->
	</div>
	<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog"
		tabindex="-1" id="courseModal" class="modal fade">
		</div>
	...
	<script src="js/order/order_validation.js"></script>
